...
CREATE FUNCTION marks_insert_trigger_function()
    RETURNS TRIGGER
    LANGUAGE PLPGSQL
AS $$
    ...
    DECLARE tablename VARCHAR(20) := 'marks';
...
CREATE TRIGGER marks_insert_trigger AFTER INSERT
ON marks
FOR EACH ROW EXECUTE PROCEDURE marks_insert_trigger_function();

-----------------------------------------------------------------------------------------------------------------------

CREATE FUNCTION marks_update_trigger_function()
    RETURNS TRIGGER
    LANGUAGE PLPGSQL
AS $$
    DECLARE recordid INTEGER := NEW.id;
...
CREATE TRIGGER marks_update_trigger AFTER UPDATE
ON marks
FOR EACH ROW EXECUTE PROCEDURE marks_update_trigger_function();

-----------------------------------------------------------------------------------------------------------------------

CREATE FUNCTION marks_delete_trigger_function()
    RETURNS TRIGGER
    LANGUAGE PLPGSQL
AS $$
...
CREATE TRIGGER marks_delete_trigger AFTER DELETE
ON marks
FOR EACH ROW EXECUTE PROCEDURE marks_delete_trigger_function();
