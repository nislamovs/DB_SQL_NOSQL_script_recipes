...
CREATE FUNCTION teachers_insert_trigger_function()
    RETURNS TRIGGER
    LANGUAGE PLPGSQL
AS $$
    ...
    DECLARE tablename VARCHAR(20) := 'teachers';
...
CREATE TRIGGER teachers_insert_trigger AFTER INSERT
ON teachers
FOR EACH ROW EXECUTE PROCEDURE teachers_insert_trigger_function();

-----------------------------------------------------------------------------------------------------------------------

CREATE FUNCTION teachers_update_trigger_function()
    RETURNS TRIGGER
    LANGUAGE PLPGSQL
AS $$
    DECLARE recordid INTEGER := NEW.id;
...
CREATE TRIGGER teachers_update_trigger AFTER UPDATE
ON teachers
FOR EACH ROW EXECUTE PROCEDURE teachers_update_trigger_function();

-----------------------------------------------------------------------------------------------------------------------

CREATE FUNCTION teachers_delete_trigger_function()
    RETURNS TRIGGER
    LANGUAGE PLPGSQL
AS $$
...
CREATE TRIGGER teachers_delete_trigger AFTER DELETE
ON teachers
FOR EACH ROW EXECUTE PROCEDURE teachers_delete_trigger_function();
