...
CREATE FUNCTION pupils_insert_trigger_function()
    RETURNS TRIGGER
    LANGUAGE PLPGSQL
AS $$
    ...
    DECLARE tablename VARCHAR(20) := 'pupils';
...
CREATE TRIGGER pupils_insert_trigger AFTER INSERT
ON pupils
FOR EACH ROW EXECUTE PROCEDURE pupils_insert_trigger_function();

-----------------------------------------------------------------------------------------------------------------------

CREATE FUNCTION pupils_update_trigger_function()
    RETURNS TRIGGER
    LANGUAGE PLPGSQL
AS $$
    DECLARE recordid INTEGER := NEW.id;
...
CREATE TRIGGER pupils_update_trigger AFTER UPDATE
ON pupils
FOR EACH ROW EXECUTE PROCEDURE pupils_update_trigger_function();

-----------------------------------------------------------------------------------------------------------------------

CREATE FUNCTION pupils_delete_trigger_function()
    RETURNS TRIGGER
    LANGUAGE PLPGSQL
AS $$
...
CREATE TRIGGER pupils_delete_trigger AFTER DELETE
ON pupils
FOR EACH ROW EXECUTE PROCEDURE pupils_delete_trigger_function();
