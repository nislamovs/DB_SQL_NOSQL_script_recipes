...
CREATE FUNCTION subjects_insert_trigger_function()
    RETURNS TRIGGER
    LANGUAGE PLPGSQL
AS $$
    ...
    DECLARE tablename VARCHAR(20) := 'subjects';
...
CREATE TRIGGER subjects_insert_trigger AFTER INSERT
ON subjects
FOR EACH ROW EXECUTE PROCEDURE subjects_insert_trigger_function();

-----------------------------------------------------------------------------------------------------------------------

CREATE FUNCTION subjects_update_trigger_function()
    RETURNS TRIGGER
    LANGUAGE PLPGSQL
AS $$
    DECLARE recordid INTEGER := NEW.id;
...
CREATE TRIGGER subjects_update_trigger AFTER UPDATE
ON subjects
FOR EACH ROW EXECUTE PROCEDURE subjects_update_trigger_function();

-----------------------------------------------------------------------------------------------------------------------

CREATE FUNCTION subjects_delete_trigger_function()
    RETURNS TRIGGER
    LANGUAGE PLPGSQL
AS $$
...
CREATE TRIGGER subjects_delete_trigger AFTER DELETE
ON subjects
FOR EACH ROW EXECUTE PROCEDURE subjects_delete_trigger_function();
